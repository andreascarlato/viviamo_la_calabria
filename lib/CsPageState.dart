...
import 'package:viviamo_la_calabria/Contenuto.dart';
import 'Cs.dart';
import 'Uici.dart';
import 'Orari.dart';
...
class CsPageState extends State<Cs>
        ...
        children: <Widget>[
          ...
          Column(
            ...
            children: <Widget>[
              ...
              itemCard('Comune di Cosenza', 'assets/cs.png', 'Sito web istituzionale','https://www.comune.cosenza.it/'),
              itemCard('News', 'assets/news.png', 'Notizie dal Comune','https://comune.cosenza.it/pagina12_notizie.html'),
              itemCard('Contatti', 'assets/orari.png','Riferimenti e contatti','https://cosenza.etrasparenza.it/pagina65_telefono-e-posta-elettronica.html'),
              //Contenuto('ciao', 'assets/catalogo.png', 'description')
            ],
          )
        ],
      ),
