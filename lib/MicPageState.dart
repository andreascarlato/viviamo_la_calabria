...
class MicPageState extends State<Mic>
        ...
        children: <Widget>[
          ...
          Column(
            ...
            children: <Widget>[
              ...
              itemCard('Direzione Regionale Musei Calabria', 'assets/mic.png', 'Sito web istituzionale', 'https://musei.calabria.beniculturali.it'),
              itemCard('News', 'assets/news.png', 'Notizie ed eventi', 'https://musei.calabria.beniculturali.it/notizie'),
              itemCard('Contatti', 'assets/orari.png','Riferimenti e contatti','https://musei.calabria.beniculturali.it/https-musei-calabria-cultura-gov-it')
            ],
          )
        ],
      ),
